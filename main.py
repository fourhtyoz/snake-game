...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.paren_screen = parent_screen
        self.x = SIZE * 3
        self.y = SIZE * 3
    
    def draw(self):
        self.paren_screen.blit(self.apple,(self.x, self.y))
...
class Game:
    def __init__(self):
        ...
        self.surface = pygame.display.set_mode((SCREEN_HEIGHT, SCREEN_WIDTH))
